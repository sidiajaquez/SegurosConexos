...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Constancia.FechaPago'
        db.add_column('Constancia', 'FechaPago',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Constancia.Estatus'
        db.add_column('Constancia', 'Estatus',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Constancia.FechaPago'
        db.delete_column('Constancia', 'FechaPago')

        # Deleting field 'Constancia.Estatus'
        db.delete_column('Constancia', 'Estatus')
