...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Constancia'
        db.create_table('Constancia', (
            ('IdConstancia', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Solicitud', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Solicitud.Solicitud'])),
            ('VigenciaInicio', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('VigenciaFin', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FechaEmision', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FolioConstancia', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('SumaAsegurada', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('CuotaNeta', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'Constancias', ['Constancia'])

        # Adding model 'ConstanciaCobertura'
        db.create_table('ConstanciaCobertura', (
            ('IdConstanciaCobertura', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Constancia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Constancias.Constancia'])),
            ('IdCobertura', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('Tarifa', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('TarifaFondo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('TarifaReaseguro', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('CuotaFondo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('CuotaReaseguro', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'Constancias', ['ConstanciaCobertura'])


    def backwards(self, orm):
        # Deleting model 'Constancia'
        db.delete_table('Constancia')

        # Deleting model 'ConstanciaCobertura'
        db.delete_table('ConstanciaCobertura')
    ...
    models = {
        ...
        u'Constancias.constancia': {
            'CuotaNeta': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'FechaEmision': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'SumaAsegurada': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'VigenciaFin': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'VigenciaInicio': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
        u'Constancias.constanciacobertura': {
            'Constancia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Constancias.Constancia']"}),
            'CuotaFondo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'CuotaReaseguro': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'Tarifa': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'TarifaFondo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'TarifaReaseguro': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'})
        },
