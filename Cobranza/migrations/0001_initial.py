...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pago'
        db.create_table('Pago', (
            ('IdPago', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Constancia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Constancias.Constancia'])),
            ('FolioRecibo', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal(u'Cobranza', ['Pago'])


    def backwards(self, orm):
        # Deleting model 'Pago'
        db.delete_table('Pago')


    models = {
        u'Cobranza.pago': {
            'Constancia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Constancias.Constancia']"}),
            'FolioRecibo': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'IdPago': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'Meta': {'ordering': "('IdPago',)", 'object_name': 'Pago', 'db_table': "'Pago'"}
        },
