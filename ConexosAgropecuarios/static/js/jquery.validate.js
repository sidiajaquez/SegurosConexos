...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Por favor ingrese fecha valida",
		dateISO: "Please enter a valid date (ISO).",
		number: "Por favor ingrese campo valido",
		digits: "Por favor ingrese solo números",
		creditcard: "Por favor ingrese un número de tarjeta valido.",
		equalTo: "Please enter the same value again.",
		maxlength: $.validator.format("Longitud invalida."),
		minlength: $.validator.format("Longitud invalida."),
