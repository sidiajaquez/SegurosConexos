...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beneficiario.Porcentaje'
        db.add_column('Beneficiario', 'Porcentaje',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beneficiario.Porcentaje'
        db.delete_column('Beneficiario', 'Porcentaje')
