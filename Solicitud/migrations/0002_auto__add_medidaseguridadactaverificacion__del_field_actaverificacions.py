...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MedidaSeguridadActaVerificacion'
        db.create_table('MedidaSeguridadActaVerificacion', (
            ('IdMedidaSeguridad', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ActaVerificacionSolicitud', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Solicitud.ActaVerificacionSolicitud'])),
            ('MedidasSeguridad', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'Solicitud', ['MedidaSeguridadActaVerificacion'])

        # Deleting field 'ActaVerificacionSolicitud.MedidasSeguridad'
        db.delete_column('ActaVerificacionSolicitud', 'MedidasSeguridad')


    def backwards(self, orm):
        # Deleting model 'MedidaSeguridadActaVerificacion'
        db.delete_table('MedidaSeguridadActaVerificacion')

        # Adding field 'ActaVerificacionSolicitud.MedidasSeguridad'
        db.add_column('ActaVerificacionSolicitud', 'MedidasSeguridad',
