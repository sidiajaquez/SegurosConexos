...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'Solicitud.descripciondetalladabienactaverificacion': {
            ...
            'IdDescripcionDetalladaBienActaVerificacion': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'Marca': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'Meta': {'ordering': "('IdDescripcionDetalladaBienActaVerificacion',)", 'object_name': 'DescripcionDetalladaBienActaVerificacion', 'db_table': "'DescripcionDetalladaBienActaVerificacion'"},
