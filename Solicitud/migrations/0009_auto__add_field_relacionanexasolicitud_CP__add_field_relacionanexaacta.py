...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelacionAnexaSolicitud.CP'
        db.add_column('RelacionAnexaSolicitud', 'CP',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RelacionAnexaActaVerificacion.CP'
        db.add_column('RelacionAnexaActaVerificacion', 'CP',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelacionAnexaSolicitud.CP'
        db.delete_column('RelacionAnexaSolicitud', 'CP')

        # Deleting field 'RelacionAnexaActaVerificacion.CP'
        db.delete_column('RelacionAnexaActaVerificacion', 'CP')
    ...
    models = {
        ...
        u'Solicitud.beneficiario': {
            ...
            'Porcentaje': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'Solicitud': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Solicitud.Solicitud']"})
        },
        ...
        u'Solicitud.relacionanexaactaverificacion': {
            'CP': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
