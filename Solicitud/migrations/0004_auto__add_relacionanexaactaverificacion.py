...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RelacionAnexaActaVerificacion'
        db.create_table('RelacionAnexaActaVerificacion', (
            ('IdRelacionAnexaActaVerificacion', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('FechaRelacionAnexaActaVerificacion', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'Solicitud', ['RelacionAnexaActaVerificacion'])


    def backwards(self, orm):
        # Deleting model 'RelacionAnexaActaVerificacion'
        db.delete_table('RelacionAnexaActaVerificacion')
