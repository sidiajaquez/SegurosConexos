...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solicitud.Estatus'
        db.add_column('Solicitud', 'Estatus',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ActaVerificacionSolicitud.AceptadoRechazado'
        db.delete_column('ActaVerificacionSolicitud', 'AceptadoRechazado')


    def backwards(self, orm):
        # Deleting field 'Solicitud.Estatus'
        db.delete_column('Solicitud', 'Estatus')

        # Adding field 'ActaVerificacionSolicitud.AceptadoRechazado'
        db.add_column('ActaVerificacionSolicitud', 'AceptadoRechazado',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
