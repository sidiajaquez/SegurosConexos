...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DescripcionDetalladaBienActaVerificacion'
        db.delete_table('DescripcionDetalladaBienActaVerificacion')

        # Adding model 'DescripcionBienActaVerificacion'
        db.create_table('DescripcionBienActaVerificacion', (
            ('IdDescripcionBienActaVerificacion', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'Solicitud', ['DescripcionBienActaVerificacion'])


    def backwards(self, orm):
        # Adding model 'DescripcionDetalladaBienActaVerificacion'
        db.create_table('DescripcionDetalladaBienActaVerificacion', (
            ('RelacionAnexaActaVerificacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Solicitud.RelacionAnexaActaVerificacion'])),
            ('DocumentacionEvaluacion', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('IdDescripcionDetalladaBienActaVerificacion', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('NombreEquipo', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('Cantidad', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ValorUnitario', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('Marca', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ...
        db.send_create_signal(u'Solicitud', ['DescripcionDetalladaBienActaVerificacion'])

        # Deleting model 'DescripcionBienActaVerificacion'
        db.delete_table('DescripcionBienActaVerificacion')
    ...
    models = {
        ...
        u'Solicitud.descripcionbienactaverificacion': {
            ...
            'IdDescripcionBienActaVerificacion': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'Marca': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'Meta': {'ordering': "('IdDescripcionBienActaVerificacion',)", 'object_name': 'DescripcionBienActaVerificacion', 'db_table': "'DescripcionBienActaVerificacion'"},
