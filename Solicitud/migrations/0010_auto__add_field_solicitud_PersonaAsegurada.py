...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solicitud.PersonaAsegurada'
        db.add_column('Solicitud', 'PersonaAsegurada',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='PersonaAsegurada', to=orm['ConexosAgropecuarios.Persona']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solicitud.PersonaAsegurada'
        db.delete_column('Solicitud', 'PersonaAsegurada_id')
