...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cotizador.TotalTarifa'
        db.add_column('cotizador', 'TotalTarifa',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cotizador.TotalTarifa'
        db.delete_column('cotizador', 'TotalTarifa')
    ...
    models = {
        ...
        u'Cotizador.cotizador': {
            ...
            'TotalTarifa': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2', 'blank': 'True'})
        },
